...
export default function Home() {
  ...
  return (
    <main className="min-h-screen text-white">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {bundleOffers.map((offer) => (
              ...
              >
                ...
                <div
                  className={`relative h-full backdrop-blur-xl bg-white/[0.02] border rounded-3xl p-8 transition-all duration-500 ${
                    offer.bestValue
                ...
                >
                  ...
                  <p className="text-zinc-400 text-sm mb-6">{offer.desc}</p>
      ...
      <section id="products" className="pb-24 px-6 bg-black">
